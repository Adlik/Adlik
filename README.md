...
registry.cn-beijing.aliyuncs.com/adlik/model-compiler:v0.7.0_trt8.4.3.1_openvino2022.3.0_cuda11.6
...
1. Run the image.
   ...
   registry.cn-beijing.aliyuncs.com/adlik/model-compiler:v0.7.0_trt8.4.3.1_openvino2022.3.0_cuda11.6 bash
   ```
...
registry.cn-beijing.aliyuncs.com/adlik/serving-tflite-cpu:v0.6.0

registry.cn-beijing.aliyuncs.com/adlik/serving-tensorflow-cpu:v0.7.0

registry.cn-beijing.aliyuncs.com/adlik/serving-openvino:v0.7.0

registry.cn-beijing.aliyuncs.com/adlik/serving-libtorch-cpu:v0.7.0

GPU:

registry.cn-beijing.aliyuncs.com/adlik/serving-tftrt-gpu:v0.6.0

registry.cn-beijing.aliyuncs.com/adlik/serving-tensorrt:v0.6.0_trt8.4.3.1_cuda11.6

registry.cn-beijing.aliyuncs.com/adlik/serving-libtorch-gpu:v0.7.0
...
1. Run the mirror and pay attention to mapping out the service port.
   ...
   registry.cn-beijing.aliyuncs.com/adlik/serving-openvino:v0.7.0 bash
   ```
