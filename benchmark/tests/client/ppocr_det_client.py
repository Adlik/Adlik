...
def _main():
    ...
    output_name = context.model_config.output[0].name
...
if __name__ == '__main__':
    ...
    parser.add_argument('-m', '--model-name', type=str, required=False, default='db',
                        help='Name of model')
    ...
    parser.add_argument('-u', '--url', type=str, required=False, default='localhost:9500',
                        help='Server URL. Default is localhost:9500.')
