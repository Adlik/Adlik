...
FIXTURE(OptionalTest){TEST("DefaultConstructor"){Optional<int> empty;
ASSERT_FALSE(empty);
}  // namespace cub
...
TEST("MoveAssignment") {
  ...
  Optional<Listenable> empty_to_empty, empty_to_set, set_to_empty(inplace), set_to_set(inplace);
