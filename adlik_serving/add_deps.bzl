...
def add_all_deps():
    ...
    http_archive(
        ...
        strip_prefix = "tensorflow-92a6bb06549e74a8bd8cdb8e28552496e5520007",
        urls = [
            "https://github.com/tensorflow/tensorflow/archive/92a6bb06549e74a8bd8cdb8e28552496e5520007.tar.gz",
        ],
    )
